  ...
  return (
    <form onSubmit={handleSubmit}>
      <Flex direction="column" gap="2">
        <label className="label" htmlFor="url">Url des recettes à importer *</label>
        <TextField.Root name="url" id="url" placeholder='https://example.com/recipe' onChange={handleChange} disabled={isLoading} error={error}>
          <TextField.Slot>
            {isLoading ?
              <Spinner size="2" />
              :
        ...
        <Button type="submit" onClick={handleSubmit} disabled={isLoading || !url || !validUrl}>Importer</Button>
      </Flex>
    </form >
  );
};
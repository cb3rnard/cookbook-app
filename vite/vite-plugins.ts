...
export function generateTwigTemplate(): Plugin {
  return {
    ...
    async writeBundle(options: any, bundle: any) {
      try {
        ...
        // Convert to Twig template
        const twigTemplate = convertHtmlToTwig(indexHtml);

        // Write to dist/templates/home/
        ...
        console.log('✅ Twig template generated:', templatePath);
      } catch (error) {
        console.error('❌ Erreur génération template Twig:', error);
      }
    },
  };
}
